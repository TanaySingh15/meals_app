...
import 'package:meals_app/Screen/categories_meals_screen.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => TabsScreen(_favouriteMeals), //Home Screen alwas /
        ...
        //'/meal-item': (context) => MealDetailScreen(),
      },

      // when you don't know where to navigate or any anomality is attained
